...
class MainActivity : AppCompatActivity() {
    class MainActivity : AppCompatActivity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            tvPhrase = findViewById(R.id.rvMain)
        ...
        private fun addMessage(){
            ...
            if(guessPhrase){
                ...
                if(msg.isNotEmpty() && msg.length==1){
                    ...
                    Snackbar.make(rvMain, "Please enter one letter only", Snackbar.LENGTH_LONG).show()
                }
            }
        ...
        private fun updateText(){
            tvPhrase.text = "Phrase:  " + myAnswer.uppercase(Locale.getDefault())
